...
class OnboardingController extends GetxController {
  ...
  final List<OnboardingItem> items = [
    OnboardingItem(
      title: 'Welcome to Rumah Sakit Hermina,',
      description:
          'Tempat terbaik kamu untuk merawat dan menyembuhkan semua masalah kesehatan kamu!',
      imagePath: 'assets/onboarding/onboarding_1.jpg',
    ),
    OnboardingItem(
      title: 'Track Medical Records',
      description:
          'Simpan semua riwayat medis, resep obat, dan hasil tes Anda di satu tempat yang aman.',
      imagePath: 'assets/onboarding/onboarding_2.jpg',
    ),
    OnboardingItem(
      title: 'Doctor Appointments',
      description:
          'Kelola janji temu dengan penyedia layanan kesehatan Anda dan dapatkan pengingat tepat waktu.',
      imagePath: 'assets/onboarding/onboarding_3.jpg',
    ),
    OnboardingItem(
      title: 'Medication Management',
      description: 'Jangan pernah melewatkan dosis dengan pelacakan obat dan pengingat.',
      imagePath: 'assets/onboarding/onboarding_1.jpg',
      actionText: 'Mulai Aplikasi',
    ),
  ];
